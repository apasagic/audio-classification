...
Training data is generated by concatenating randomly selected drum samples (with intermittent periods of silence of random lenght) and applying augumentation.
Input audio data is typically of 4 different types of drums, as seen below:

<img width="610" height="420" alt="image" src="https://github.com/user-attachments/assets/a008b2a2-7942-4e43-ae9f-9566e61b4335" />

Before concatenation along time axis, data is first transformed into spectrograms using STFT with NFFT of 1024 bins.
...
After concatenation, and with labels being generated from the file/folder names, training and validation data batch samples look somewhat like the example shown below (before augmentation):
